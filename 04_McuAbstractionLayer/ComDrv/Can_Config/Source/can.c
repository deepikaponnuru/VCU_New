...
//     MCAN_init(MCANA_DRIVER_BASE, &can_Config.initParams);
//     MCAN_setBitTime(MCANA_DRIVER_BASE, &can_Config.bitTimes);
//     MCAN_msgRAMConfig(MCANA_DRIVER_BASE, &can_Config.msgRAMConfigParams);

//     for(i=0; i <NUM_OF_MSG ;i++)
//     {
//         MCAN_addExtMsgIDFilter(MCANA_DRIVER_BASE, i, &Can_FiltEle[i]);
//     }
...
// // static void MCANIntrConfig_Tx(void)
// // {
// //     Interrupt_register(INT_MCANA_0,&MCANIntr1ISR_Tx);
...
// // {
// //     uint32_t i=0;
// //     TxIntrStatus = MCAN_getIntrStatus(MCANA_DRIVER_BASE);

// //     MCAN_clearIntrStatus(MCANA_DRIVER_BASE, TxIntrStatus);

    
// //     //  Clearing the interrupt lineNum
    
// //    MCAN_clearInterrupt(MCANA_DRIVER_BASE, 0x1);
// //    if(flagtx==1)
// //    {
// //     for(loopCnt=0;loopCnt<NUM_OF_MSG;loopCnt++)
// //         {
